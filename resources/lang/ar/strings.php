...
return array (
  ...
  array (
    ...
    array (
      ...
      'you_have' => 
      array (
        'messages' => '{0} ليس لديك رسائل | {1} لديك رسالة واحدة | [2 ، Inf] لديك :number رسائل ',
        'notifications' => '{0} ليس لديك إعلامات | {1} لديك إشعار واحد | [2 ، Inf] لديك :number إعلامات ',
        'tasks' => '{0} ليس لديك مهام | {1} لديك مهمة واحدة | [2 ، Inf] لديك  :number المهام',
      ),
    ),
    'menu_manager' => 
    array (
  ...
  array (
    ...
    array (
      ...
      'you_can_see_because_permission' => 'يمكنك رؤية هذا لأنك تملك إذن ":role"!',
      'you_can_see_because' => 'يمكنك أن ترى هذا لأن لديك صلاحية ":permission "',
      'view_console_it_works' => 'عرض وحدة التحكم ، سترى "إنه يعمل!" الذي يأتي من فهرس FrontendController @',
      'using_blade_extensions' => 'استخدام ملحقات blade',
    ),
    'welcome_to' => 'مرحبا بكم في:place',
    'user' => 
    array (
